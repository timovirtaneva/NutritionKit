...
extension NutritionItem: CustomStringConvertible {
    ...
    public static let knownLabelsFinnish: [NutritionItem: Set<String>] = [
        ...
        .transFat: [],
        .carbohydrates: ["hiilihydraatteja", "hiilihydraatit", "hiilihydraatti"],
        .sugar: ["josta sokeria", "josta sokereita", "sokeri", "sokeria"],
        .addedSugar: [],
        .sugarAlcohols: [],
        .starch: ["josta tärkkelystä", "tärkkelys", "tärkkelystä"],
        .dietaryFiber: ["ravintokuitua", "ravintokuitu", "kuitu", "kuitua"],
        .protein: ["proteiinia", "proteiini"],
        .salt: ["suolaa", "suola"],
